		...
		public static function register( $wp_customize ) {
			...
			$wp_customize->selective_refresh->add_partial(
				...
				array(
					...
					'render_callback' => 'SQM_customize_partial_blogname',
				)
			);
			...
			$wp_customize->selective_refresh->add_partial(
				...
				array(
					...
					'render_callback' => 'SQM_customize_partial_blogdescription',
				)
			);
			...
			$wp_customize->selective_refresh->add_partial(
				...
				array(
					...
					'render_callback' => 'SQM_customize_partial_site_logo',
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'priority'    => 10,
					'label'       => __( 'Retina logo', 'SQM' ),
					'description' => __( 'Scales the logo to half its uploaded size, making it sharp on high-res screens.', 'SQM' ),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'header_footer_background_color',
					array(
						'label'   => __( 'Header &amp; Footer Background Color', 'SQM' ),
						'section' => 'colors',
					)
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					'type'    => 'radio',
					'section' => 'colors',
					'label'   => __( 'Primary Color', 'SQM' ),
					'choices' => array(
						'default' => _x( 'Default', 'color', 'SQM' ),
						'custom'  => _x( 'Custom', 'color', 'SQM' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'section'         => 'colors',
						'settings'        => 'accent_hue',
						'description'     => __( 'Apply a custom color for links, buttons, featured images.', 'SQM' ),
						'mode'            => 'hue',
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'Show search in header', 'SQM' ),
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'On archive pages, posts show:', 'SQM' ),
					'choices'  => array(
						'full'    => __( 'Full text', 'SQM' ),
						'summary' => __( 'Summary', 'SQM' ),
					),
				)
			);
			...
			$wp_customize->add_section(
				...
				array(
					'title'       => __( 'Cover Template', 'SQM' ),
					'capability'  => 'edit_theme_options',
					'description' => __( 'Settings for the "Cover Template" page template. Add a featured image to use as background.', 'SQM' ),
					'priority'    => 42,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'       => __( 'Fixed Background Image', 'SQM' ),
					'description' => __( 'Creates a parallax effect when the visitor scrolls.', 'SQM' ),
				)
			);
			...
			$wp_customize->add_setting(
				...
				array(
					'default'           => SQM_get_color_for_area( 'content', 'accent' ),
					'sanitize_callback' => 'sanitize_hex_color',
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_background_color',
					array(
						'label'       => __( 'Overlay Background Color', 'SQM' ),
						'description' => __( 'The color used for the overlay. Defaults to the accent color.', 'SQM' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_text_color',
					array(
						'label'       => __( 'Overlay Text Color', 'SQM' ),
						'description' => __( 'The color used for the text in the overlay.', 'SQM' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				'cover_template_overlay_opacity',
				array(
					'label'       => __( 'Overlay Opacity', 'SQM' ),
					'description' => __( 'Make sure that the contrast is high enough so that the text is readable.', 'SQM' ),
					'section'     => 'cover_template_options',
					'type'        => 'range',
					'input_attrs' => SQM_customize_opacity_range(),
				)
			);
 ...
 * */
if ( ! function_exists( 'SQM_customize_partial_blogname' ) ) {
	/**
	 * Render the site title for the selective refresh partial.
	 */
	function SQM_customize_partial_blogname() {
		bloginfo( 'name' );
	}
}

if ( ! function_exists( 'SQM_customize_partial_blogdescription' ) ) {
	/**
	 * Render the site description for the selective refresh partial.
	 */
	function SQM_customize_partial_blogdescription() {
		bloginfo( 'description' );
	}
}

if ( ! function_exists( 'SQM_customize_partial_site_logo' ) ) {
	/**
	 * Render the site logo for the selective refresh partial.
	 *
	 * Doing it this way so we don't have issues with `render_callback`'s arguments.
	 */
	function SQM_customize_partial_site_logo() {
		SQM_site_logo();
	}
}
 ...
 */
function SQM_customize_opacity_range() {
	/**
