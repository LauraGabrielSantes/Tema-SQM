<?php
/**
 * A template partial to output pagination for the SQM default theme.
 *
...
$prev_text = sprintf(
	...
	__( 'Newer <span class="nav-short">Posts</span>', 'SQM' )
);
$next_text = sprintf(
	'<span class="nav-next-text">%s</span> %s',
	__( 'Older <span class="nav-short">Posts</span>', 'SQM' ),
